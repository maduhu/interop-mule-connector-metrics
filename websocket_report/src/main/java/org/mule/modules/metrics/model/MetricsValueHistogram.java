...
public class MetricsValueHistogram implements MetricsValue {
	...
	public MetricsValueHistogram(String name_id, long timeStamp) {
		super();
	...
	public String toString() {
		return "MetricsValueTimer [name_id=" + name_id + ", timeStamp="
				+ timeStamp + ", count=" + count + ", max=" + max + ", mean="
				+ mean + ", min=" + min + ", stddev=" + stddev + ", p50=" + p50
				+ ", p75=" + p75 + ", p95=" + p95 + ", p98=" + p98 + ", p99="
				+ p99 + ", p999=" + p999 + "]";
	}
